    ...
    <div class="n-verifyForm">
      ...
      <div v-if="step === 2">
        ...
        <form class="verification-card" @submit.prevent="verifyOtp">
          ...
          <p
            class="resend"
            @click="resendCooldown === 0 ? sendOtp() : null"
      ...
      <div v-if="step === 3 && userType === 'worker'">
        ...
        <form class="verification-card" @submit.prevent="submitId">
          ...
          <div class="row-actions">
            ...
            <button type="button" class="link-button" @click="skipStep">
              Skip for now
            </button>
          </div>
        </form>
...
export default {
  ...
  methods: {
    async sendOtp() {
      if (!this.email) {
        this.globalError = "Please enter your email.";
        return;
      }
