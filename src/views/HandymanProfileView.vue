...
<template>
  <main v-if="pro" class="profile-page">
    <aside class="profile-sidebar">
      <button class="profile-brand" @click="router.push('/')"><span>⌕</span> CraftsmanLink</button>
      <p>CATEGORIES</p>
